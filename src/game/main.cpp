...
int main()
{
	...
	cubeComponent->renderInit("../shaders/PBRShader.txt", "../models/cube.obj", "../Summi_Pool/Summi_Pool_preview.jpg", false, cam, "../models/grey.png", "../models/grey.png", "../models/grey.png", "../models/grey.png", "../models/grey.png");
